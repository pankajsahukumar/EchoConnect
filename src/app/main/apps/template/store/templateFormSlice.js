...
export const selectCurrentTemplate = (state) =>
    state.templateApp.templateForm.currentTemplate;

export const selectTemplateErrors = (state) =>
    state.templateApp.templateForm.errors;
...
const templateFormSlice = createSlice({
    ...
    reducers: {
        ...
        updateCurrentTemplate: (state, action) => {
            let updateTemplateState = { ...state.currentTemplate, ...action.payload };
